...
import com.google.firebase.example.ServiceFireBaseQuy.MapUser_Location;
import com.google.firebase.example.ServiceFireBaseQuy.Province_User;
...
public class ServiceFireBaseDung {
    ...
    private static final String POINT_START = "ĐIỂM ĐẦU";
    private static final String POINT_END = "ĐIỂM CUỐI";
	
    private static final String[] countries = {"Việt nam", "vietnam", "viet nam"};
    public  static    Hashtable<String,KeyMap > hshKeyMap;
    /**
     * @author hung
     *
     */
    ...
    public static class KeyMap {
        ...
        public KeyMap(String Type, String Id) {
            // [START_EXCLUDE]
            this.Type = Type;
            this.Id = Id;
    ...
    public void service1(){
        ...
        hshKeyMap = new Hashtable<String,KeyMap >();
...
//						});		
    ...
    public void service(){
    	...
    	DatabaseReference firebaseKey_Map = database.getReference(TABLE_KEY_MAP);
    	
    	
		String cityName = "Hà Nội";
	 
		String f="1";
		KeyMap ciyMap = new KeyMap("City", f);
		firebaseKey_Map.child(cityName).setValue(ciyMap);
		  cityName = "Việt Nam";
		 
		  f=null;
		  ciyMap = new KeyMap("Country", f);
		firebaseKey_Map.child(cityName).setValue(ciyMap);
    	
    	firebaseKey_Map.addChildEventListener(new ChildEventListener() {
...
//				// 1. Get location from Temp
				KeyMap psKeyMap  = snapshot.getValue(KeyMap.class);
 				String key = snapshot.getKey();
 				if(!hshKeyMap.containsKey(key))
 					hshKeyMap.put(key, psKeyMap);
    		}
    ...
    //	ValueEventListener
    	firebaseLocationTemp.addChildEventListener(new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
				...
				// TODO Auto-generated method stub
				Locations location  = snapshot.getValue(Locations.class);
				LocationBoImpl  locaBo =new LocationBoImpl();
				locaBo.createLocation(location);
